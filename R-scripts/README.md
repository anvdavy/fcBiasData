This folder contains R scripts implementing experiments for studying statistical properties of various metrics for forecast accuracy and bias from (Davydenko and Goodwin, 2021).
References:
